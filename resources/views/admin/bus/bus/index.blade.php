        ...
        <div class="col-md-12">
            <div class="panel panel-white">
                <div class="panel-header">
                    <h4 class="panel-title">Bus List <div class="pull-right"><a href="{{ route('admin.bus.buses.new') }}" class="btn btn-success btn-rounded"><span class="fa fa-plus"></span> Create Bus</a></div></h4>
                </div>
